...
class FamilyParentController extends Controller
{
    ...
    public function verifyAccount($id)
    {
        ...
        $whatsapp_urls = $parent->users->map(function ($user) use ($parent) {
            $message = "Hai {$parent->mother_fullname}, akun Anda sudah diverifikasi. Silakan masuk ke POSYANDU HARAPAN BUNDA dengan nama pengguna dan kata sandi yang telah Anda buat. Terima kasih dan Salam Sehat!";
    ...
    public function resetAccount($id)
    {
        ...
        $whatsapp_urls = $parent->users->map(function ($user) use ($parent) {
            $message = "Hai {$parent->mother_fullname}, akun Anda sudah direset. Silakan masuk ke POSYANDU HARAPAN BUNDA dengan nama pengguna dan kata sandi menggunakan NIK: {$parent->nik}. Terima kasih dan Salam Sehat!";
            $message_urlencode = urlencode($message);
            return "https://wa.me/{$user->phone_number}?text={$message_urlencode}";
        });
