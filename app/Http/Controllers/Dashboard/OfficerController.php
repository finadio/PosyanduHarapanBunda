...
class OfficerController extends Controller
{
    ...
    public function resetAccount($id)
    {
        ...
        $whatsapp_urls = $officer->users->map(function ($user) use ($officer) {
            $message = "Hai {$officer->fullname}, akun Anda sudah direset. Silakan masuk ke POSYANDU HARAPAN BUNDA dengan nama pengguna dan kata sandi menggunakan NIK: {$officer->nik}. Terima kasih dan Salam Sehat!";
