    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body p-3">
                ...
                <div class="mb-4">
                    <p class="text-lead">
                        Jika Anda membutuhkan bantuan atau memiliki pertanyaan, silakan hubungi admin melalui WhatsApp:
                        <span class="text-success">{{ $site->phone_number ?? '-' }}</span>
                ...
                @if ($site && $site->phone_number && $site->village_name)
                    <a href="https://wa.me/{{ $site->phone_number }}?text=Hai Admin POSYANDU HARAPAN BUNDA {{ $site->village_name }}."
                        target="_blank" class="btn btn-success w-100">
                        <i class="fab fa-whatsapp mr-1"></i> Hubungi Admin
                    </a>
                @else
                    <button class="btn btn-secondary w-100" disabled>
                        <i class="fas fa-info-circle mr-1"></i> Kontak belum tersedia
                    </button>
                @endif
            </div>
        </div>
